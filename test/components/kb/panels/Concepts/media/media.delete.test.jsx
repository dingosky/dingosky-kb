...
describe('Media Delete - Single Media Item', () => {
  ...
  it('deletes the only image media item', async () => {
    ...
    render(
      <MediaTestWrapper initialMedia={initialMedia}>
        <Concepts />
      </MediaTestWrapper>
    )
...
describe('Media Delete - Edge Cases', () => {
  ...
  it('handles deletion of media with long caption', async () => {
    ...
    const longCaption = 'This is a very long caption that describes the media item in great detail, including information about the subject, the location, the time of day, and various other relevant details that might be useful for understanding the context of the image.'
